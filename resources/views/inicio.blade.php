...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="bg-white/80 backdrop-blur-md border border-gray-100 shadow-sm rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">
                <i class="bi bi-geo-alt"></i> Unidad Funcional {{ $id_uf }}
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-[#FA8072] rounded-2xl p-6 text-white shadow-lg shadow-red-500/20 relative overflow-hidden">
                <div class="absolute -right-4 -top-4 w-24 h-24 bg-white opacity-10 rounded-full blur-xl"></div>
                
                <p class="text-white/80 text-sm font-medium mb-1">Saldo a pagar</p>
                <h2 class="text-3xl font-bold">$ 0.00</h2>
                
                <div class="mt-4 text-xs bg-white/20 rounded-lg py-1.5 px-3 backdrop-blur-sm inline-block">
                    <i class="bi bi-check-circle mr-1"></i> Expensas al día
                </div>
            </div>
            ...
            <div class="bg-white/60 backdrop-blur-md border border-gray-100 rounded-2xl p-5 shadow-sm">
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex justify-between items-center border-b border-gray-50 pb-2">
                        <span class="text-gray-500">ID Sistema</span>
